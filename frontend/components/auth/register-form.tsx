...
import { CreditCard, Eye, EyeOff, FileText, Info, Lock, Mail, Upload, User } from "lucide-react";
    ...
    <label className="block">
      ...
      <span className="relative block">
        ...
        <input
          ...
          className={`w-full rounded-lg border bg-white px-3 py-2 pl-10 pr-11 text-gray-900 transition-colors placeholder:text-gray-400 focus:outline-none focus:ring-2 dark:bg-gray-800 dark:text-gray-100 ${
            invalid
        ...
        <button
          ...
          onClick={onToggle}
          disabled={disabled}
          className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md p-1 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
